...
## Methods
Some text about stats and techniques, and some code. I do my work with summary tables here... and I only include the summary tables I actually analyze. And that analysis matches my research question.
```{r}
