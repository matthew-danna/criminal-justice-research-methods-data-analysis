...
#### Two different types of data sources:

##### Events
1. FBI UCR SHR
https://cde.ucr.cjis.gov/LATEST/webapp/#/pages/explorer/crime/shr

Specifically, the Expanded Homicide Data
Filter by weapon
Do separate downloads for unique time periods and/or areas (jurisdictions)
...
This results in multiple downloads - either multiple years of data, or multiple states of data
...
U.S. - DHS Customs & Border Protection
https://www.cbp.gov/document/stats/weapons-and-ammunition-seizures
...
Option 1: Manually convert the state rankings into a table
Option 2: Explore by State - pick select states of interest, Compare, and manually convert data into a table
Option 3: Explore by Policy - pick select policies, manually convert data into a table
