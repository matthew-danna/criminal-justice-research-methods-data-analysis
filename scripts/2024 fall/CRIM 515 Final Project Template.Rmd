...
These instructions will demonstrate how to forecast using an ARIMA model.
...
2. Graph your monthly forecasts:
```{r}
...
Provide a graph showing the forecasted counts at least three visuals of your data. These visuals should be relevant to your research and used as aids to articulate your findings. Think of these as support/evidence for your words. These visuals can be any combination of charts, tables, graphs, maps, or other similar graphics. All visuals should be intuitive and logical, meaning the reader can understand them without an additional explanation. 
